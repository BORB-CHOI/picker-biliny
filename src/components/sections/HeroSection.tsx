...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={innerRef}
        className="hero-inner relative z-10 px-[clamp(12px,1.39vw,20px)] pb-[clamp(16px,2.22vw,32px)] w-full max-w-[clamp(190px,26.39vw,380px)] mx-auto"
      >
        {/* PICKER PROJECT wordmark */}
        <div className="flex items-center gap-[0.14vw] mb-[clamp(14px,0.49vw,28px)] ml-1">
          <WordmarkLogoHorizon width={240} fill="#192746" className="w-[clamp(120px,16.67vw,240px)] h-auto" />
        </div>

        {/* Main heading */}
        <h1 className="mb-[clamp(14px,0.49vw,28px)]">
          <span className="block text-[clamp(24px,3.33vw,48px)] font-bold tracking-[0.06em] text-(--color-hero-title) leading-tight">
            중소도시의 이동권을
          </span>
          <span className="block text-[clamp(24px,3.33vw,48px)] font-bold tracking-[0.06em] text-(--color-primary) leading-tight mt-1">
            다시 설계합니다.
          </span>
        </h1>

        {/* Horizontal decorative line */}
        <div className="h-px bg-[#D8D8D8] w-full max-w-[clamp(50px,9.03vw,130px)] mb-[clamp(14px,0.49vw,28px)]" />

        {/* Description */}
        <p className="text-[clamp(10px,1.25vw,18px)] text-(--color-text-desc) leading-[1.85] max-w-[clamp(200px,31.94vw,460px)] mb-[clamp(20px,0.83vw,48px)]">
        ...
        <div className="flex gap-[clamp(7px,0.97vw,14px)]">
          <a
            href="#story"
            className="inline-flex items-center gap-[clamp(5px,0.69vw,10px)] px-[clamp(12px,1.67vw,24px)] py-[clamp(6px,0.83vw,12px)] bg-[#4B4B4B] text-white text-[clamp(8px,0.97vw,14px)] font-bold rounded-[clamp(6px,0.76vw,11px)] shadow-[0_2px_6px_rgba(75,75,75,0.25)] hover:bg-[#3a3a3a] transition-colors"
          >
          ...
          <a
            href="#biliny"
            className="inline-flex items-center gap-[clamp(5px,0.69vw,10px)] px-[clamp(12px,1.67vw,24px)] py-[clamp(6px,0.83vw,12px)] bg-[#2675FF] text-white text-[clamp(8px,0.97vw,14px)] font-bold rounded-[clamp(6px,0.76vw,11px)] shadow-[0_2px_6px_rgba(57,57,255,0.25)] hover:bg-[#1a5ee6] transition-colors"
          >
