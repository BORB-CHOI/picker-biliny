    ...
    <section ref={sectionRef} id="story" className="relative bg-white overflow-hidden">
      <div className="w-full max-w-[1440px] mx-auto px-5 md:px-[5%]">
        ...
        {/* ────────────────────────────────────
            1970 할아버지 — 트럭 운전
        ──────────────────────────────────── */}
        <div className="mt-[4vw] flex flex-col items-center gap-[2vw]">
          <p className="s-fade story-year">1970</p>
          <div className="s-img w-full md:w-[70%]">
            <Image
        ...
        {/* ────────────────────────────────────
            2026 할아버지 — 벤치
        ──────────────────────────────────── */}
        <div className="mt-[12vw] flex flex-col md:flex-row items-center md:items-end gap-[3vw]">
          <div className="s-img w-[60%] md:w-[35%] order-1 md:order-2">
            <p className="s-fade story-year text-center mb-[1vw]">2026</p>
            <Image
          ...
          <p className="s-reveal story-text text-center md:text-left order-2 md:order-1 md:w-[55%] md:pb-[3vw]">
        ...
        {/* ────────────────────────────────────
            1970 할머니 — 힘차게 걸음
        ──────────────────────────────────── */}
        <div className="mt-[12vw] flex flex-col md:flex-row-reverse items-center md:items-end gap-[3vw]">
          <div className="s-img w-[65%] md:w-[48%]">
            <p className="s-fade story-year text-center mb-[1vw]">1970</p>
            <Image
          ...
          <p className="s-reveal story-text text-center md:text-right md:w-[45%] md:pb-[3vw]">
        ...
        ──────────────────────────────────── */}
        <div className="mt-[12vw] flex flex-col md:flex-row items-center md:items-end gap-[3vw]">
          <p className="s-reveal story-text text-center md:text-left md:w-[40%] md:pb-[3vw]">
        ...
        {/* ═══════════════════════════════════════
            불편한 대안들
        ═══════════════════════════════════════ */}
        <h2 className="s-reveal story-heading mt-[18vw] text-center md:text-left md:w-[60%]">
          불편한 대안들
        </h2>
        ...
        <div className="mt-[18vw] flex flex-col items-center">
          ...
          {/* 3열 그리드 */}
          <div className="s-fade grid grid-cols-3 w-[85%] md:w-[55%] mt-[3vw] gap-4">
          ...
          <div className="mt-[6vw] flex flex-col md:flex-row items-center gap-[3vw] w-full md:w-[80%] mx-auto">
            ...
            <div className="s-reveal text-center md:text-right flex-1">
              ...
              <p className="story-conclusion-quote mt-[2vw]">고립 &nbsp; 우울 가속화</p>
              <p className="story-data-number mt-[1vw]">1.5배</p>
            </div>
          </div>
        </div>
